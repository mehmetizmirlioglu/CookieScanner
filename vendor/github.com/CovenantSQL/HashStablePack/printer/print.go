...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{}
	myImports = append(myImports, `hsp "github.com/mehmetizmirlioglu/HashStablePack/marshalhash"`)
	...
	if mode&gen.Test == gen.Test {
		...
		writeImportHeader(testbuf, "bytes", "crypto/rand", "encoding/binary", `hsp "github.com/mehmetizmirlioglu/HashStablePack/marshalhash"`, "testing")
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	b.WriteString("// Code generated by github.com/mehmetizmirlioglu/HashStablePack DO NOT EDIT.\n\n")
}
